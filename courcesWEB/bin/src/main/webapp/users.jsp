		...
		<div class="lines mt-60">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 bgcolo">
					<a role="button" class="btn btn-default cb-all-center active" href="/admin/users">Пользователи</a><br> <a role="button"
						...
						<tbody>
							<c:forEach var="user" items="${userList}">
								<tr>
									...
									<td><button class="btn btn-default" type="button" data-toggle="modal" data-target="#teacherAdd">Сделать учителем</button>
										<div id="teacherAdd" class="modal fade">
											<div class="modal-dialog">
												<div class="modal-content">
													<form method="post" action="/admin/users/${user.id}?command=setTeacher">
														<div class="modal-header">
															<button class="close" type="button" data-dismiss="modal">×</button>
															<h4 class="modal-title">Добавьте описание</h4>
														</div>
														<div class="modal-body">
															<div class="form-group">
																<label for="exampleFormControlTextarea1">Введите описание учителя</label> <textarea class="form-control" id="description"
																	name="description" rows="10"></textarea>
															</div>
														</div>
														<div class="modal-footer">
															<button type="submit" class="btn btn-default">Сделать учителем</button>
															<button class="btn btn-default" type="button" data-dismiss="modal">Закрыть</button>
														</div>
													</form>
												</div>
