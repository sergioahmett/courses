					...
					<table id="example" class="display" style="width: 100%">
						<thead>
							<tr>
								...
								<th><fmt:message key="table.toTeacher" /></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="user" items="${userList}">
								<tr>
									...
									<td><button class="btn btn-default" type="button" data-toggle="modal" data-target="#teacherAdd">
											<fmt:message key="table.toTeacher" />
										</button>
												...
												<div class="modal-content">
													<form method="post" action="/admin/users/${user.id}?command=setTeacher">
														<div class="modal-header">
															<button class="close" type="button" data-dismiss="modal">×</button>
															<h4 class="modal-title">
																<fmt:message key="teacher.addDesc" />
															</h4>
														</div>
														<div class="modal-body">
															<div class="form-group">
																<label for="exampleFormControlTextarea1"><fmt:message key="teacher.addDesc" /></label> <textarea class="form-control" id="description"
