		...
		<div class="bottomLines">
			<div class="row col-lg-10 col-lg-offset-1 bgcolor tableWrapper">
				<table id="example" class="display" style="width: 100%">
					...
					<tbody>
						<c:forEach var="theme" items="${resultList}">
							<tr>
								<td><c:out value="${theme.theme.title}" /></td>
								<td><c:out value="${theme.theme.description}" /></td>
								<td><c:out value="${theme.courseList.size()}" /></td>
								<td><a role="button" class="btn btn-default cb-all-center" href="/themes/${theme.theme.id}"><fmt:message key="table.more" /></a></td>
							</tr>
						</c:forEach>
					</tbody>
					<tfoot>
